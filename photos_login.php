...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['password']) && $_POST['password'] === $correctPassword) {
        $_SESSION['admin1_access'] = true;
        header("Location: photos_logs.php");
        exit();
    } else {
...
<head>
    ...
    <title>Photo's Portal | MIS-FUMB Attendance System</title>
...
<body>
    ...
    <div class="container">
        <h1 style="color:#004080;">Photo's Portal</h1>
        <form method="post" action="photos_login.php">
